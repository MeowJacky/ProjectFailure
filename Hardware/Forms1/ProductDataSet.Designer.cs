...
namespace Forms1 {
    ...
    public partial class ProductDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Product_Name, string Description, int Stock, decimal Price, byte[] Image, string ProductRFID, string FIleName) {
...
namespace Forms1.ProductDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([Product_Name] = @Original_Product_Name) AND ([Stock] = @Original_Stock) AND ([Price] = @Original_Price) AND ([ProductRFID] = @Original_ProductRFID) AND ([FIleName] = @Original_FIleName))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Product_Name], [Description], [Stock], [Price], [Image], [ProductRFID], [FIleName]) VALUES (@Product_Name, @Description, @Stock, @Price, @Image, @ProductRFID, @FIleName);
SELECT ProductID, Product_Name, Description, Stock, Price, Image, ProductRFID, FIleName FROM Products WHERE (ProductID = SCOPE_IDENTITY())";
...
SELECT ProductID, Product_Name, Description, Stock, Price, Image, ProductRFID, FIleName FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual int Delete(int Original_ProductID, string Original_Product_Name, int Original_Stock, decimal Original_Price, string Original_ProductRFID, string Original_FIleName) {
        ...
        public virtual int Insert(string Product_Name, string Description, int Stock, decimal Price, byte[] Image, string ProductRFID, string FIleName) {
        ...
        public virtual int Update(string Product_Name, string Description, int Stock, decimal Price, byte[] Image, string ProductRFID, string FIleName, int Original_ProductID, string Original_Product_Name, int Original_Stock, decimal Original_Price, string Original_ProductRFID, string Original_FIleName, int ProductID) {
            if ((Product_Name == null)) {
                throw new global::System.ArgumentNullException("Product_Name");
            }
            else {
            ...
            if ((Original_ProductRFID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_ProductRFID));
            }
            if ((Original_FIleName == null)) {
                throw new global::System.ArgumentNullException("Original_FIleName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Product_Name, string Description, int Stock, decimal Price, byte[] Image, string ProductRFID, string FIleName, int Original_ProductID, string Original_Product_Name, int Original_Stock, decimal Original_Price, string Original_ProductRFID, string Original_FIleName) {
            return this.Update(Product_Name, Description, Stock, Price, Image, ProductRFID, FIleName, Original_ProductID, Original_Product_Name, Original_Stock, Original_Price, Original_ProductRFID, Original_FIleName, Original_ProductID);
        }
    }
